...
public class InitController {
    ...
    final String sController = "InitController";
    private GetDataFromFbService getDataFromFbService;
     ...
     */
    @Autowired
    public InitController(Logger logger,
            GetDataFromFbService getDataFromFbService) {
        this.logger = logger;
        this.getDataFromFbService = getDataFromFbService;
    ...
    public ResponseEntity<String> init(HttpServletRequest req, HttpServletResponse resp) {
        ...
        response = getDataFromFbService.parse(req);
